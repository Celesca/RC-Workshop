			  ...
			  <tbody>
				<tr class="table-primary m-auto">
				  <td width="92">ลำดับ</td>
					<td width="165">รหัสนักศึกษา</td>
					<td width="161">ชื่อ-สกุล</td>
				  <td width="162">เริ่มต้น</td>
				  <td width="157">สิ้นสุด</td>
				  <td width="185">รายละเอียด</td>
				...
				<tr class="table-sm m-auto ">
				  ...
				  <td><a class="btn btn-primary btn-md" href="request_accept.php?id=<?php echo $row['reserve_id']; ?>" role="button">อนุมัติ</a>
					<a class="btn btn-danger btn-md" href="accept_save.php?cons=0&reserve_id=<?php echo $row['reserve_id']; ?>" role="button" onClick="return confirm('ยืนยันการปฏิเสธ?')">ปฏิเสธ</a>
					</td>
				</tr>
				  <?php } ?>
			  </tbody>
